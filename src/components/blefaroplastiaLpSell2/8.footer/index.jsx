    ...
    <Styled.Container>
      <div className="initial-footer">
        <div className="container-initial-footer">
          <p className="address">Endereço: Av. Nova Independência, 1087 –
      ...
      <div className="end-footer">
        <div className="container-end-footer">
          ...
          <a href=""><p>Política de privacidade | Termos de serviço</p></a>
          <p className="brazil"><img src={brazil} />PT/BR</p>
        </div>
      </div>
    </Styled.Container>
  );
