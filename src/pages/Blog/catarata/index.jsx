    ...
    <>
      ...
      <Styled.Container>
        ...
        <section>
          ...
          <p data-aos="fade-right">É a opacificação do cristalino.</p>
        ...
        <br />
        <section>
          <h2 data-aos="fade-right">O que causa catarata?</h2>
          <br data-aos="fade-right" />
        ...
        <br />
        <section>
          <h2 data-aos="fade-right">Catarata pode causar cegueira?</h2>
          <br />
          <p data-aos="fade-right">
        ...
        <br />
        <section>
          <h2 data-aos="fade-right">Como saber se tenho catarata?</h2>
        ...
        <br />
        <section>
          <h2 data-aos="fade-right">Tratamento de catarata:</h2>
          <br />
        ...
        <br />
        <section>
          <h2 data-aos="fade-right">Como é feita a cirurgia de catarata:</h2>
          <br />
          ...
          <div data-aos="fade-up"><YoutubeEmbed embedId="R6SCGmtHg2w" /></div>
        </section>
        <br />
        <br />
        <section>
          <h2 data-aos="fade-right">Quanto tempo demora a cirurgia de catarata?</h2>
          <br />
        ...
        <br />
        <section>
          <h2 data-aos="fade-right">Tem risco na cirurgia de catarata?</h2>
          <br />
        ...
        <br />
        <section>
          <h2 data-aos="fade-right">Qual o preço de uma cirurgia de catarata:</h2>
          <br />
        ...
        <br />
        <section>
          <h2 data-aos="fade-right">Como fazer a Cirurgia de Catarata pelo SUS:</h2>
          <br />
          ...
          <img className="fullImg" src={FilaSus} alt="Fila de espera do SUS" data-aos="fade-up" />
          <br />
        ...
        <br />
        <section>
          <h2 data-aos="fade-right">Quanto tempo demora para sair cirurgia de catarata pelo SUS?</h2>
          <br />
        ...
        <br />
        <section>
          <h2 data-aos="fade-right">Quem tem diabetes pode fazer cirurgia de catarata?</h2>
          <br />
          <p data-aos="fade-right">
        ...
        <br />
        <section>
          <h2 data-aos="fade-right">Quem tem pressão alta pode fazer cirurgia de catarata?</h2>
          <br />
          <p data-aos="fade-right">
            Sim, mas é necessário uma correta avaliação prévia pelo médico
            oftalmologista.
