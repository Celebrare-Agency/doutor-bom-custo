import { ContainerAuto, Header, Cover, Ortoce, Benefits, Who, Indication, Contact, Testimony, Map } from "./style";
          ...
          <div className="Orto">
            <div className="containerOrto">
              <div className="textsOrto">
                <h2><div className="line"></div>Liberdade Total Durante o Dia</h2>
                ...
                <p>Simples, eficaz e sem dor, essa é a solução para Who busca liberdade visual sem comprometer o conforto.</p>
              </div>
          ...
          <div className="Who">
            <div className="containerWho">
              <div className="textsWho">
                <h2><div className="line"></div>Perfeita Para Who...</h2>
                <h1>Para Who é Indicada a Lente de Ortoceratologia?</h1>
