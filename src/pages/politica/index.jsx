    ...
    <Styled.Container>
      ...
      <section>
        <article>
          ...
          <p data-aos="fade-right">
            ...
            casos de participação do usuário em algum comentário ou postagem.
            Neste caso, o nome, email e depoimento poderão ser publicados,
        ...
        <article>
          ...
          <p data-aos="fade-right">
            ...
            uso de cookies diretamente no seu navegador.
          </p>
        </article>
        <article>
          ...
          <p data-aos="fade-right">
            ...
            conduzidas por elas, mesmo que não exista uma ordem judicial, por
            exemplo (e sem limitar-se a) quando tratar-se de investigação de
            caráter penal ou a violação de direitos do autor, ressalvadas as
            hipóteses de sigilo de informações determinadas por leis em vigor,
            ou ainda, comunicar informações quando haja motivos suficientes para
          ...
          <p data-aos="fade-right">
            ...
            acordo com a política de cada um deles e que podem diferenciar das
            nossas.
          </p>
        </article>
        <article>
      ...
      <footer>
        <address>
          ...
          Av. Ipiranga, 344
          <br />
          Edifício Itália, República São paulo
          <br />
        </address>
      </footer>
    </Styled.Container>
